...
class AuthenticateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('plafond', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['plafond'];
    }

    /**
     * Sets plafond
     *
     * @param int|null $plafond plafond
     *
     * @return self
     */
    ...
    {
        if (is_null($plafond)) {
            throw new \InvalidArgumentException('non-nullable plafond cannot be null');
        }
        $this->container['plafond'] = $plafond;
